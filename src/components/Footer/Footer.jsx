...
// style
import { FooterContainer, NavLink } from "./Footer-Style"
...
export function Footer(){
    return(
      <FooterContainer>
        <ul className="flex-center" style={{ gap: pxToRem(64) }}>
            <li><h2>Meu contato:</h2><NavLink href="tel:+5582987077520">+55 (82) 98707-7520</NavLink></li>
            <li><h2>Email:</h2><NavLink href="mailto:andregonzaga95@gmail.com">andregonzaga95@gmail.com</NavLink></li>
        </ul>
        <ul className="flex-center" style={{ gap: pxToRem(32) }}>
            <li>
